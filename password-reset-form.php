...
<html>
<head>
    <title>jacklouispt - Password Reset</title>
...
<body>
  ...
  <form action="reset-password.php" method="post">
    <h2 style="text-align: center; color: #333; margin-bottom: 20px;">Password Reset</h2>
    <p>Enter both your username and email to request a password reset.</p>
    <label for="username">
      <i class="fas fa-user"><img src="images/account/username.png"></i>
    </label>
    <input type="text" name="username" placeholder="Username" id="username" required>
    <label for="email">
      <i class="fas fa-lock"><img src="images/account/email.png"></i>
    </label>
